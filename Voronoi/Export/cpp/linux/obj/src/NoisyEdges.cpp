...
{
HX_STACK_PUSH("NoisyEdges::new","NoisyEdges.hx",19);
{
	HX_STACK_LINE(21)
...
{
		HX_STACK_PUSH("NoisyEdges::buildNoisyEdges","NoisyEdges.hx",30);
		HX_STACK_THIS(this);
				...
				HX_STACK_LINE(33)
				{
					...
					while(((_g2 < _g3->length))){
						...
						if (((bool((bool((bool((bool((edge1->d0 != null())) && bool((edge1->d1 != null())))) && bool((edge1->v0 != null())))) && bool((edge1->v1 != null())))) && bool((this->path0->__GetItem(edge1->index) == null()))))){
							...
							HX_STACK_LINE(41)
							int minLength = (int)10;		HX_STACK_VAR(minLength,"minLength");
							HX_STACK_LINE(42)
...
Array< ::neash::geom::Point > NoisyEdges_obj::buildNoisyLineSegments( ::de::polygonal::math::PM_PRNG random,::neash::geom::Point A,::neash::geom::Point B,::neash::geom::Point C,::neash::geom::Point D,Float minLength){
	HX_STACK_PUSH("NoisyEdges::buildNoisyLineSegments","NoisyEdges.hx",57);
	HX_STACK_ARG(random,"random");
	HX_STACK_ARG(A,"A");
	HX_STACK_ARG(B,"B");
	HX_STACK_ARG(C,"C");
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< Float > &minLength1,Array< ::de::polygonal::math::PM_PRNG > &random1,Array< Array< ::neash::geom::Point > > &points){
			HX_STACK_PUSH("*::closure","NoisyEdges.hx",60);
			{
				HX_STACK_LINE(60)
				...
				Void run(::neash::geom::Point A1,::neash::geom::Point B1,::neash::geom::Point C1,::neash::geom::Point D1){
					HX_STACK_PUSH("*::_Function_2_1","NoisyEdges.hx",60);
					HX_STACK_ARG(A1,"A1");
					HX_STACK_ARG(B1,"B1");
					HX_STACK_ARG(C1,"C1");
					HX_STACK_ARG(D1,"D1");
					{
						...
						HX_STACK_LINE(82)
						subdivide->__GetItem((int)0)(A1,::neash::geom::Point_obj::interpolate(G,B1,s),H,::neash::geom::Point_obj::interpolate(E,D1,t)).Cast< Void >();
						HX_STACK_LINE(83)
						points->__get((int)0)->push(H);
						HX_STACK_LINE(84)
						subdivide->__GetItem((int)0)(H,::neash::geom::Point_obj::interpolate(F,C1,s),C1,::neash::geom::Point_obj::interpolate(I,D1,t)).Cast< Void >();
					}
					return null();
				}
